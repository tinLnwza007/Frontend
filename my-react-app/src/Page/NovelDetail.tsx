  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={headerCard}>
        <div style={coverBox}>นิยาย</div>
        <div style={infoBox}>
          <h1 style={titleText}>ชื่อเรื่อง นิยายสุดมันส์</h1>
          
          {/* แก้ไขส่วนนี้เพื่อให้คลิกได้และมี Hover Effect */}
          <p 
            style={{ 
              ...authorText, 
              cursor: 'pointer', 
      ...
      <div style={listSection}>
        ...
        {episodes.map((ep) => (
          <div key={ep.id} style={episodeItem} onClick={() => navigate('/read-novel')}>
            <div>
